...
[![Core Plugins](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Frusherdevelopment.github.io%2Frusherhack-plugins%2Fbadges.json&query=$.totalCorePlugins.message&label=Core%20Plugins&color=green)](./CORE-PLUGINS.md)
...
- [Example Core Plugin](https://github.com/RusherDevelopment/example-core-plugin): A basic example showcasing how to create core plugins that modify internal game behavior.
...
Full list: **[Core-Plugins](./CORE-PLUGINS.md)**
