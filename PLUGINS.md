<!--
  ...
  This file is auto-generated from `data/plugins-and-themes.yml`.

  To contribute a plugin or make changes, update `data/plugins-and-themes.yml`.
  All manual edits to this file will be overwritten.
-->
...
[![Plugins](https://img.shields.io/badge/Plugins-91-green)](#plugins-list)
